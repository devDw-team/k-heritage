...
/// 관광지 위치 지도 화면
class TourMapScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TourMapScreen> createState() => _TourMapScreenState();
}

class _TourMapScreenState extends ConsumerState<TourMapScreen> {
  ...
  Future<void> _openExternalNavigation() async {
    final lat = widget.attraction.mapY ?? 37.5665;
    final lng = widget.attraction.mapX ?? 126.9780;
    final name = Uri.encodeComponent(widget.attraction.title);
      ...
      body: Stack(
        children: [
          ...
          GoogleMap(
            ...
            markers: {
              Marker(
                markerId: MarkerId(attraction.contentId),
                position: position,
                infoWindow: InfoWindow(
                  title: attraction.title,
                  snippet: attraction.address1,
                ),
              ),
            },
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (attraction.address1 != null)
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            '${attraction.address1} ${attraction.address2 ?? ''}'.trim(),
                                  ...
                                  // 전화번호
                                  if (attraction.tel != null)
                                    GestureDetector(
                                      onTap: () async {
                                        final url = 'tel:${attraction.tel}';
